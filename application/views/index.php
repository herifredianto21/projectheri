        ...
        <header class="bg-dark py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="text-center text-white">
                    ...
                    <p class="lead fw-normal text-white-50 mb-0">Welcome my E-Restaurant</p>
                </div>
            </div>
        </header>
                        ...
                        <div class="card h-100">
                            <img class="card-img-top" src="<?php echo $produk->meals[0]->strMealThumb; ?>" alt="Meals">
                                ...
                                <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                    <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="<?php echo site_url('shop/detail') ?>">Add</a></div>
                                </div>
                        </div>
                    </div>
                </div>
